...
namespace Ktisis.Interface.Components {
	public static class ControlButtons {
		...
		public static void DrawExtra() {
			...
			if (GuiHelpers.IconButtonTooltip(gizmode == ImGuizmoMode.World ? FontAwesomeIcon.Globe : FontAwesomeIcon.Home, "本地/世界坐标模式切换。", ButtonSize))
		...
		public static void ButtonChangeOperation(ImGuizmoOperation operation, FontAwesomeIcon icon) {
			...
			help += operation switch {
				ImGuizmoOperation.Translate => "位置",
				ImGuizmoOperation.Rotate => "旋转",
				ImGuizmoOperation.Scale => "缩放",
				ImGuizmoOperation.Universal => "全局",
